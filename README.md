...
1. **`SamaInventorySystem.exe`** ⭐ (البرنامج الرئيسي)
   - نظام إدارة المخزون الكامل
   - إضافة وتعديل والعناصر
   - تسجيل الحركات والعمليات
   - **ابدأ بتحميل هذا البرنامج أولاً**

2. **`SamaReportViewer.exe`** (عارض التقارير)
   - عرض التقارير والإحصائيات
   - فلاتر بحث متقدمة
   - تحليل البيانات والتصدير

#### خطوات التحميل والتشغيل:

1. **تحميل البرامج:**
   - اذهب إلى [صفحة الإصدارات](https://github.com/StrucTech/Sama-Inventory-System/releases)
   - حمل `SamaInventorySystem.exe` (أساسي)
   - حمل `SamaReportViewer.exe` (اختياري)

2. **تشغيل البرنامج:**
   - شغل `SamaInventorySystem.exe`
   - اتبع معالج الإعداد الأولي
   - **لا حاجة لتثبيت Python أو أي متطلبات إضافية!**

3. **استخدام التقارير (اختياري):**
   - شغل `SamaReportViewer.exe` لعرض التقارير المتقدمة
